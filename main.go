...
func setRouter(r *gin.Engine) {
	...
	api.Use(controllers.JWTAuthMiddleware())
	{
		...
		api.POST("/pan139/qrcode", controllers.Pan139QRCode)             // 生成中国移动云盘扫码登录二维码
		api.GET("/pan139/qrcode/status", controllers.Pan139QRCodeStatus) // 轮询中国移动云盘扫码登录状态
		...
		api.PUT("/moviepilot/subscribes/:id/promotion", controllers.UpdateMoviePilotSubscribePromotion) // 调整订阅促销优选
